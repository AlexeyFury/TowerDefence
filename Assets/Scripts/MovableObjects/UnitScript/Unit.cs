...
public class Unit : MovableObject
{
    ...
    private EntityinJson entityinJson; // Ссылка на компонент EntityinJson
    private EntityData entityData; // Переменная для хранения данных сущности
    ...
    private void Start()
    {
        ...
        //Debug.Log("ddataaaa" + entityData.distanceToEnter);
    }
    new void Awake()
    {
